...
|Ordre d'exécution|Je souhaite ?|APP VITAM UI|Rôle|
|:---------------:|:-----:|:-----:|:-----:|:-----:|
|Organisation et droits utilisateurs|||||
|1.1 (Obligatoire)|Créer une nouvelle organisation et lui associer 1 ou plusieurs coffre(s)|[[VitamUI_DocAPP_Organisation](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Organisation.pdf)|Administrateur du service (si vous exposez VITAM UI en tant que service pour d'autres utilisateurs)<br>Administrateur technique VitamUI (si vous utilisez VITAM UI hébergé en propre)|
|1.2 (Obligatoire)|Créer le compte nominatif de l'administrateur fonctionnel d'une organisation à des fins d'activation<br>Prendre la main sur la session d'un utilisateur à des fins de support|[VitamUI_DocAPP_Subrogation](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Subrogation.pdf)||
|1.3 (Facultatif)|Définir des droits fins sur la gestion des utilisateurs de mon organisation en créant un nouveau profil de droits(*) pour cette APP|[VitamUI_DocAPP_Profil_APP_Utilisateur](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Profil_APP_Utilisateur.pdf)|Administrateur fonctionnel VITAM UI|
|1.4 (Obligatoire<br>sauf si le groupe existe déjà)|Définir des regroupements de droits sur une ou plusieurs APPs du portail pour mes utilisateurs|[VitamUI_DocAPP_Groupe_profil](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Groupe_profil.pdf)|Administrateur fonctionnel|
|1.5 (Obligatoire)|Créer mes utilisateurs et leur attribuer des droits|[VitamUI_DocAPP_Utilisateur](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Utilisateur.pdf)|Administrateur fonctionnel VITAM UI|
|NA|Paramétrer des profils de droits permettant d’associer un contrat d’accès à un utilisateur|[VitamUI_DocAPP_Profil_APP_Parametrages_externes](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Profil_APP_Parametrages_externes.pdf)|Administrateur fonctionnel VITAM UI|
|NA|Créer de nouveaux profils de niveaux inférieurs, limiter l’attribution de profils à une portée d’utilisateurs et adapter la séparation des rôles|[VitamUI_DocAPP_Hierarchisation_profils](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Hierarchisation_profils.pdf)|Opérateur d’instance|
|2.1 (Obligatoire)|Déclarer un nouveau service producteur ou un nouveau service versant|[VitamUI_DocAPP_Services_agents](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Services_agents.pdf)|Administrateur fonctionnel VITAM UI|
|2.2 (Obligatoire)|Déclarer des nouvelles règles de gestion|[VitamUI_DocAPP_Regles_gestion](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Regles_gestion.pdf)|Administrateur fonctionnel VITAM UI|
|2.3 (Facultatif)|Créer et modifier un profil d’archivage (PA) ou un profil d’unité archivistique (PUA), créer et modifier une notice d’un profil, importer et exporter un profil d’archivage|[VitamUI_DocAPP_Profils_documentaires.pdf](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Profils_documentaires.pdf)|Administrateur fonctionnel VITAM UI|
|2.4 (Facultatif)|Déclarer un nouveau format non présent dans le référentiel PRONOM|[VitamUI_DocAPP_Formats_fichiers](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Formats_fichiers.pdf)|Administrateur technique VITAM UI|
|2.5 (Facultatif)|Déclarer un nouveau vocabulaire non présent dans l'ontologie SEDA|[VitamUI_DocAPP_Ontologie](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Ontologie.pdf)|Administrateur technique VITAM UI|
|2.6 (Facultatif)|Importer un arbre de positionnement ou un plan de classement|[VitamUI_DocAPP_Arbres_plans](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Arbres_plans.pdf)|Administrateur fonctionnel VITAM UI||
|2.7 (Facultatif)|Rechercher et consulter un contrat de gestion, le créer et le mettre à jour|[VitamUI_DocAPP_Contrat_gestion](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Contrat_gestion.pdf)|Administrateur fonctionnel VITAM UI|
|3.1 (Obligatoire<br>sauf si le contrat est inchangé)|Paramétrer des droits pour le versement d'archives dans un coffre par une application|[VitamUI_DocAPP_Contrat_entree](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Contrat_entree.pdf)|Administrateur fonctionnel VITAM UI|
|3.2 (Obligatoire<br>sauf si le contrat est inchangé)|Paramétrer des droits pour la consultation ou mise à jour d'archives dans un coffre par une application|[VitamUI_DocAPP_Contrat_acces](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Contrat_acces.pdf)|Administrateur fonctionnel VITAM UI|
|3.3 (Obligatoire<br>sauf si le profil est inchangé)|Définir les droits d'une application sur les services VITAM|[VitamUI_DocAPP_Profil_securité](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Profil_securite.pdf)|Administrateur technique VITAM UI|
|3.4 (Obligatoire<br>sauf si le contexte est inchangé)|Authentifier une application interconnectée avec VITAM et lui attribuer des droits|[VitamUI_DocAPP_Contexte_applicatif](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Contexte_applicatif.pdf)|Administrateur technique VITAM UI|
|NA|Consulter le journal des opérations VITAM (entrées, éliminations et données de base)|[VitamUI_DocAPP_Journal_operations](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Journal_operations.pdf)|Administrateur fonctionnel VITAM UI<br>Administrateur technique VITAM UI<br>Super-archiviste|
|NA|Visualiser les opérations de sécurisation et accéder aux journaux du cycle de vie des objets|[VitamUI_DocAPP_Operations_securisation](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Operations_securisation.pdf)|Administrateur technique VITAM UI|
|NA|Effectuer des requêtes complexes sur les bases de données documentaires en vue de retrouver des objets|[VitamUI_DocAPP_RequetesDSL](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_RequetesDSL.pdf)|Administrateur technique VITAM UI|
|NA|Vérifier la conformité de la conservation de mes archives|[VitamUI_DocAPP_Audits](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Audit.pdf)|Administrateur fonctionnel VITAM UI<vr>Super-archiviste|
|NA|Produire un relevé de valeur probante sur une ou plusieurs de mes archives électroniques|[VitamUI_DocAPP_Releve_valeur_probante](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Releve_valeur_probante.pdf)|Administrateur fonctionnel VITAM UI<br>Super-archiviste|
|NA|Gérer des opérations et interagir sur les étapes du workflow des opérations|[VitamUI_DocAPP_Gestion_operations](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Gestion_operations.pdf)|Administrateur technique VITAM UI|
|NA|Créer un projet de versement, consulter et rechercher les unités archivistiques liées à un versement, ajouter des métadonnées descriptives et de gestion des unités archivistiques, consulter, valider, transférer les versements liés à un projet|[VitamUI_DocAPP_Collecte_et_préparation_des_versements](VitamUI_DocAPP_Collecte_et_préparation_des_versements.pdf)|Archiviste / service versant|
|NA|Déposer un lot d'archives dans le SAE et en visualiser l'entrée|[VitamUI_DocAPP_Depot_suivi_versements](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Depot_et_suivi_versements.pdf)|Archiviste|
|NA|Rechercher et télécharger des unités archivistiques contenues dans le SAE|[VitamUI_DocAPP_Recherche_consultation](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Recherche_et_consultation.pdf)|Archiviste|
|NA|Consulter le registre des fonds et rechercher dans le registre des fonds|[VitamUI_DocAPP_Registre_des_fonds](https://www.programmevitam.fr/ressources/DocCourante/autres/fonctionnel/VitamUI_DocAPP_Registre_des_fonds.pdf)|Administrateur fonctionnel VITAM UI|
