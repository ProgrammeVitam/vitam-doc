...
Le programme est également un opérateur de services depuis l'automne 2021 avec la mise à disposition de ["Vitam accessible en service"](https://www.programmevitam.fr/pages/VaS/) et l'exploitation d'Axone, système d'archivage électronique du ministère de la Justice.
Il est par ailleurs l'éditeur d'outils de facilitation des traitements archivistiques avec [ReSIP](https://www.programmevitam.fr/pages/ressources/resip/), [Pastis](https://www.programmevitam.fr/pages/ressources/pastis/) et [Archifiltre](https://www.programmevitam.fr/pages/ressources/logiciel_archifiltre/).
